...
typedef struct vuv__Uv_timespec vuv__Uv_timespec;
...
// added by module `builtin`, file: builtin_d_gcboehm.c.v:127:
...
// added by module `vuv`, file: flags.v:23:
...
#include "uv.h"
#else
#error VERROR_MESSAGE Header file "uv.h", needed for module `vuv` was not found. Please install the corresponding development headers.
#endif
...
typedef enum {
	vuv__Uv_udp_flags__udp_ipv6_only = 1, // 1
	vuv__Uv_udp_flags__udp_partial = 2, // 2
	vuv__Uv_udp_flags__udp_reuseaddr = 4, // 4
	vuv__Uv_udp_flags__udp_mmsg_chunk = 8, // 8
	vuv__Uv_udp_flags__udp_mmsg_free = 16, // 16
	vuv__Uv_udp_flags__udp_linux_recverr = 32, // 32
	vuv__Uv_udp_flags__udp_reuseport = 64, // 64
	vuv__Uv_udp_flags__udp_recvmmsg = 256, // 256
}  vuv__Uv_udp_flags;

typedef enum {
	vuv__Uv_tty_mode__tty_mode_normal = 0, // 0
	vuv__Uv_tty_mode__tty_mode_raw, // 0+1
	vuv__Uv_tty_mode__tty_mode_io, // 0+2
}  vuv__Uv_tty_mode;

typedef enum {
	vuv__Uv_tty_vtermstate__tty_supported, // 
	vuv__Uv_tty_vtermstate__tty_unsupported, // +1
}  vuv__Uv_tty_vtermstate;

typedef enum {
	vuv__Uv_stdio_flags__ignore = 0x00, // 0x00
	vuv__Uv_stdio_flags__create_pipe = 0x01, // 0x01
	vuv__Uv_stdio_flags__inherit_fd = 0x02, // 0x02
	vuv__Uv_stdio_flags__inherit_stream = 0x04, // 0x04
	vuv__Uv_stdio_flags__readable_pipe = 0x10, // 0x10
	vuv__Uv_stdio_flags__writable_pipe = 0x20, // 0x20
	vuv__Uv_stdio_flags__nonblock_pipe = 0x40, // 0x40
}  vuv__Uv_stdio_flags;

typedef enum {
	vuv__Uv_process_flags__setuid, // 
	vuv__Uv_process_flags__setgid, // +1
	vuv__Uv_process_flags__windows_verbatim_arguments, // +2
	vuv__Uv_process_flags__detached, // +3
	vuv__Uv_process_flags__windows_hide, // +4
	vuv__Uv_process_flags__windows_hide_console, // +5
...
typedef enum {
	...
	vuv__Uv_fs_type__fs_custom, // -1+1
	vuv__Uv_fs_type__fs_open, // -1+2
	vuv__Uv_fs_type__fs_close, // -1+3
	vuv__Uv_fs_type__fs_read, // -1+4
	vuv__Uv_fs_type__fs_write, // -1+5
	vuv__Uv_fs_type__fs_sendfile, // -1+6
	vuv__Uv_fs_type__fs_stat, // -1+7
	vuv__Uv_fs_type__fs_lstat, // -1+8
	vuv__Uv_fs_type__fs_fstat, // -1+9
	vuv__Uv_fs_type__fs_ftruncate, // -1+10
	vuv__Uv_fs_type__fs_utime, // -1+11
	vuv__Uv_fs_type__fs_futime, // -1+12
	vuv__Uv_fs_type__fs_access, // -1+13
	vuv__Uv_fs_type__fs_chmod, // -1+14
	vuv__Uv_fs_type__fs_fchmod, // -1+15
	vuv__Uv_fs_type__fs_fsync, // -1+16
	vuv__Uv_fs_type__fs_fdatasync, // -1+17
	vuv__Uv_fs_type__fs_unlink, // -1+18
	vuv__Uv_fs_type__fs_rmdir, // -1+19
	vuv__Uv_fs_type__fs_mkdir, // -1+20
	vuv__Uv_fs_type__fs_mktemp, // -1+21
	vuv__Uv_fs_type__fs_rename, // -1+22
	vuv__Uv_fs_type__fs_scandir, // -1+23
	vuv__Uv_fs_type__fs_link, // -1+24
	vuv__Uv_fs_type__fs_symlink, // -1+25
	vuv__Uv_fs_type__fs_readlink, // -1+26
	vuv__Uv_fs_type__fs_chown, // -1+27
	vuv__Uv_fs_type__fs_fchown, // -1+28
	vuv__Uv_fs_type__fs_realpath, // -1+29
	vuv__Uv_fs_type__fs_copyfile, // -1+30
	vuv__Uv_fs_type__fs_lchown, // -1+31
	vuv__Uv_fs_type__fs_opendir, // -1+32
	vuv__Uv_fs_type__fs_readdir, // -1+33
	vuv__Uv_fs_type__fs_closedir, // -1+34
	vuv__Uv_fs_type__fs_statfs, // -1+35
	vuv__Uv_fs_type__fs_mkstemp, // -1+36
	vuv__Uv_fs_type__fs_lutime, // -1+37
}  vuv__Uv_fs_type;

typedef enum {
	vuv__Uv_fs_event_flags__fs_event_watch_entry = 1, // 1
	vuv__Uv_fs_event_flags__fs_event_stat = 2, // 2
	vuv__Uv_fs_event_flags__fs_event_recursive = 4, // 4
...
typedef enum {
	...
	vuv__Mode__once, // 0+1
	vuv__Mode__nowait, // 0+2
}  vuv__Mode;

typedef enum {
	vuv__Uv_handle_type__unknown_handle = 0, // 0
	vuv__Uv_handle_type__async, // 0+1
	vuv__Uv_handle_type__check, // 0+2
	vuv__Uv_handle_type__fs_event, // 0+3
	vuv__Uv_handle_type__fs_poll, // 0+4
	vuv__Uv_handle_type__handle, // 0+5
	vuv__Uv_handle_type__idle, // 0+6
	vuv__Uv_handle_type__pipe, // 0+7
	vuv__Uv_handle_type__poll, // 0+8
	vuv__Uv_handle_type__prepare, // 0+9
	vuv__Uv_handle_type__process, // 0+10
	vuv__Uv_handle_type__stream, // 0+11
	vuv__Uv_handle_type__tcp, // 0+12
	vuv__Uv_handle_type__timer, // 0+13
	vuv__Uv_handle_type__tty, // 0+14
	vuv__Uv_handle_type__udp, // 0+15
	vuv__Uv_handle_type__signal, // 0+16
	vuv__Uv_handle_type__file, // 0+17
	vuv__Uv_handle_type__handle_type_max, // 0+18
}  vuv__Uv_handle_type;

typedef enum {
	vuv__Uv_req_type__unknown_req = 0, // 0
	vuv__Uv_req_type__req, // 0+1
	vuv__Uv_req_type__connect, // 0+2
	vuv__Uv_req_type__write, // 0+3
	vuv__Uv_req_type__shutdown, // 0+4
	vuv__Uv_req_type__udp_send, // 0+5
	vuv__Uv_req_type__fs, // 0+6
	vuv__Uv_req_type__work, // 0+7
	vuv__Uv_req_type__getaddrinfo, // 0+8
	vuv__Uv_req_type__getnameinfo, // 0+9
	vuv__Uv_req_type__random, // 0+10
	vuv__Uv_req_type__req_type_max, // 0+11
}  vuv__Uv_req_type;

typedef enum {
	vuv__Uv_membership__leave_group = 0, // 0
	vuv__Uv_membership__join_group, // 0+1
}  vuv__Uv_membership;

typedef enum {
	vuv__Uv_loop_option__block_signal = 0, // 0
...
typedef uv_tcp_t vuv__Uv_tcp_t;
typedef uv_loop_t vuv__Uv_loop_t;
typedef struct sockaddr_in vuv__Sockaddr_in;
typedef struct sockaddr vuv__Sockaddr;
typedef uv_stream_t vuv__Uv_stream_t;
...
typedef uv_tty_t vuv__Uv_tty_t;
typedef uv_poll_t vuv__Uv_poll_t;
typedef uv_timer_t vuv__Uv_timer_t;
typedef uv_prepare_t vuv__Uv_prepare_t;
typedef uv_check_t vuv__Uv_check_t;
typedef uv_idle_t vuv__Uv_idle_t;
typedef uv_async_t vuv__Uv_async_t;
typedef uv_process_t vuv__Uv_process_t;
typedef uv_fs_event_t vuv__Uv_fs_event_t;
typedef uv_fs_poll_t vuv__Uv_fs_poll_t;
typedef uv_signal_t vuv__Uv_signal_t;
typedef uv_req_t vuv__Uv_req_t;
typedef uv_getaddrinfo_t vuv__Uv_getaddrinfo_t;
typedef uv_getnameinfo_t vuv__Uv_getnameinfo_t;
typedef uv_shutdown_t vuv__Uv_shutdown_t;
typedef uv_connect_t vuv__Uv_connect_t;
typedef uv_udp_send_t vuv__Uv_udp_send_t;
typedef uv_fs_t vuv__Uv_fs_t;
typedef uv_work_t vuv__Uv_work_t;
typedef uv_random_t vuv__Uv_random_t;
typedef uv_env_item_t vuv__Uv_env_item_t;
typedef uv_cpu_info_t vuv__Uv_cpu_info_t;
typedef uv_interface_address_t vuv__Uv_interface_address_t;
typedef uv_dirent_t vuv__Uv_dirent_t;
typedef uv_passwd_t vuv__Uv_passwd_t;
typedef uv_group_t vuv__Uv_group_t;
...
typedef u8* (*vuv__Malloc_fn)(isize);
typedef u8* (*vuv__Realloc_fn)(u8*,isize);
typedef u8* (*vuv__Calloc_fn)(usize,usize);
typedef voidptr (*vuv__Free_fn)(voidptr);
typedef void (*vuv__Alloc_cb)(uv_handle_t*,usize,uv_buf_t*);
typedef void (*vuv__Read_cb)(uv_stream_t*,isize,uv_buf_t*);
typedef void (*vuv__Write_cb)(uv_write_t*,int);
typedef void (*vuv__Connect_cb)(uv_connect_t*,int);
typedef void (*vuv__Shutdown_cb)(uv_shutdown_t*,int);
typedef void (*vuv__Connection_cb)(uv_stream_t*,int);
typedef void (*vuv__Close_cb)(uv_handle_t*);
typedef void (*vuv__Poll_cb)(uv_poll_t*,int,int);
typedef void (*vuv__Timer_cb)(uv_timer_t*);
typedef void (*vuv__Async_cb)(uv_async_t*);
typedef void (*vuv__Prepare_cb)(uv_prepare_t*);
typedef void (*vuv__Check_cb)(uv_check_t*);
typedef void (*vuv__Idle_cb)(uv_idle_t*);
typedef void (*vuv__Exit_cb)(uv_process_t*,i64,int);
typedef void (*vuv__Walk_cb)(uv_handle_t*,voidptr);
typedef void (*vuv__Fs_cb)(uv_fs_t*);
typedef void (*vuv__Work_cb)(uv_work_t*);
typedef void (*vuv__AfterWork_cb)(uv_work_t*,int);
typedef void (*vuv__Getaddrinfo_cb)(uv_getaddrinfo_t*,int,struct addrinfo*);
typedef void (*vuv__Getnameinfo_cb)(uv_getnameinfo_t*,int,char*,char*);
typedef void (*vuv__Random_cb)(uv_random_t*,int,voidptr,usize);
typedef void (*vuv__FsEvent_cb)(uv_fs_event_t*,char*,int,int);
typedef void (*vuv__FsPoll_cb)(uv_fs_poll_t*,int,uv_stat_t*,uv_stat_t*);
typedef void (*vuv__Signal_cb)(uv_signal_t*,int);
typedef void (*anon_fn_c__uv_handle_t_voidptr)(uv_handle_t*,voidptr);
typedef void (*anon_fn_c__uv_handle_t)(uv_handle_t*);
typedef void (*anon_fn_c__uv_connect_t_int)(uv_connect_t*,int);
typedef void (*vuv__Udp_send_cb)(uv_udp_send_t*,int);
typedef void (*vuv__Udp_recv_cb)(uv_udp_t*,isize,uv_buf_t*,struct sockaddr*,vuv__Uv_udp_flags);
typedef void (*anon_fn_c__uv_udp_send_t_int)(uv_udp_send_t*,int);
typedef void (*anon_fn_c__uv_handle_t_usize_c__uv_buf_t)(uv_handle_t*,usize,uv_buf_t*);
typedef void (*anon_fn_c__uv_udp_t_isize_c__uv_buf_t_c__sockaddr_u32)(uv_udp_t*,isize,uv_buf_t*,struct sockaddr*,u32);
typedef void (*anon_fn_c__uv_poll_t_int_int)(uv_poll_t*,int,int);
typedef void (*anon_fn_c__uv_prepare_t)(uv_prepare_t*);
typedef void (*anon_fn_c__uv_check_t)(uv_check_t*);
typedef void (*anon_fn_c__uv_idle_t)(uv_idle_t*);
typedef void (*anon_fn_c__uv_async_t)(uv_async_t*);
typedef void (*anon_fn_c__uv_timer_t)(uv_timer_t*);
typedef void (*anon_fn_c__uv_getaddrinfo_t_int_c__addrinfo)(uv_getaddrinfo_t*,int,struct addrinfo*);
typedef void (*anon_fn_c__uv_getnameinfo_t_int_char_char)(uv_getnameinfo_t*,int,char*,char*);
typedef void (*anon_fn_c__uv_work_t)(uv_work_t*);
typedef void (*anon_fn_c__uv_work_t_int)(uv_work_t*,int);
typedef void (*anon_fn_c__uv_fs_t)(uv_fs_t*);
typedef void (*anon_fn_c__uv_fs_poll_t_int_c__uv_stat_t_c__uv_stat_t)(uv_fs_poll_t*,int,uv_stat_t*,uv_stat_t*);
typedef void (*anon_fn_c__uv_signal_t_int)(uv_signal_t*,int);
typedef void (*anon_fn_c__uv_fs_event_t_char_int_int)(uv_fs_event_t*,char*,int,int);
...
VV_LOCAL_SYMBOL  int compare_12729529726086286208_RepIndex_by_idx(RepIndex* a, RepIndex* b) {
...
u32 vuv__version(void);
string vuv__version_string(void);
void vuv__library_shutdown(void);
int vuv__replace_allocator(u8* (*malloc_fn)(isize size), u8* (*realloc_cb)(u8* ptr, isize size), u8* (*calloc_cb)(usize count, usize size), voidptr (*free_cb)(voidptr ptr));
uv_loop_t* vuv__default_loop(void);
int vuv__loop_init(uv_loop_t* loop);
int vuv__loop_close(uv_loop_t* loop);
uv_loop_t* vuv__loop_new(void);
void vuv__loop_delete(uv_loop_t* loop);
usize vuv__loop_size(void);
int vuv__loop_alive(const uv_loop_t* const_loop);
int vuv__loop_configure(uv_loop_t* loop, vuv__Uv_loop_option option, Array_voidptr args);
int vuv__loop_fork(uv_loop_t* loop);
int vuv__run(uv_loop_t* loop, vuv__Mode mode);
void vuv__stop(uv_loop_t* loop);
void vuv__ref(uv_handle_t* handle);
void vuv__unref(uv_handle_t* handle);
int vuv__has_ref(const uv_handle_t* const_handle);
void vuv__update_time(uv_loop_t* loop);
u64 vuv__now(const uv_loop_t* const_loop);
int vuv__backend_fd(uv_loop_t* loop);
int vuv__backend_timeout(uv_loop_t* loop);
int vuv__translate_sys_error(int sys_errno);
string vuv__strerror(int err);
string vuv__err_name_r(int err, char* buff, u64 buflen);
string vuv__err_name(int const_err);
int vuv__shutdown(uv_shutdown_t* req, uv_stream_t* handle, void (*cb)(uv_shutdown_t* req, int status));
usize vuv__handle_size(vuv__Uv_handle_type handle_type);
vuv__Uv_handle_type vuv__handle_get_type(const uv_handle_t* const_handle);
string vuv__handle_type_name(vuv__Uv_handle_type const_handle_type);
voidptr vuv__handle_get_data(const uv_handle_t* const_handle);
uv_loop_t* vuv__handle_get_loop(const uv_handle_t* const_handle);
void vuv__handle_set_data(uv_handle_t* handle, voidptr data);
usize vuv__req_size(vuv__Uv_req_type req_type);
voidptr vuv__req_get_data(const uv_req_t* const_req);
void vuv__req_set_data(uv_req_t* req, voidptr data);
vuv__Uv_req_type vuv__req_get_type(const uv_req_t* const_req);
string vuv__req_type_name(vuv__Uv_req_type const_req_type);
int vuv__is_active(const uv_handle_t* const_handle);
void vuv__walk(uv_loop_t* loop, void (*walk_cb)(uv_handle_t* handle, voidptr arg), voidptr arg);
void vuv__print_all_handles(uv_loop_t* loop, FILE* file);
void vuv__print_active_handles(uv_loop_t* loop, FILE* file);
void vuv__close(uv_handle_t* handle, void (*close_cb)(uv_handle_t* handle));
...
uv_buf_t vuv__buf_init(u8* base, usize len);
...
int vuv__read_start(uv_stream_t* stream, void (*alloc_cb)(uv_handle_t* handle, usize suggested_size, uv_buf_t* buf), void (*read_cb)(uv_stream_t* stream, isize nread, uv_buf_t* buf));
int vuv__read_stop(uv_stream_t* stream);
int vuv__write(uv_write_t* req, uv_stream_t* handle, const uv_buf_t* const_bufs, usize nbufs, void (*cb)(uv_write_t* req, int status));
int vuv__write2(uv_write_t* req, uv_stream_t* handle, const uv_buf_t* const_bufs, usize nbufs, uv_stream_t* send_handle, void (*cb)(uv_write_t* req, int status));
int vuv__try_write(uv_stream_t* handle, const uv_buf_t* const_bufs, usize nbufs);
int vuv__try_write2(uv_stream_t* handle, const uv_buf_t* const_bufs, usize nbufs, uv_stream_t* send_handle);
int vuv__is_readable(const uv_stream_t* const_handle);
int vuv__is_writable(const uv_stream_t* const_handle);
int vuv__stream_set_blocking(uv_stream_t* handle, int blocking);
int vuv__is_closing(const uv_handle_t* const_handle);
int vuv__tcp_init(uv_loop_t* loop, uv_tcp_t* handle);
int vuv__tcp_init_ex(uv_loop_t* loop, uv_tcp_t* handle, usize flags);
int vuv__tcp_open(uv_tcp_t* handle, int sock);
int vuv__tcp_nodelay(uv_tcp_t* handle, int enable);
int vuv__tcp_keepalive(uv_tcp_t* handle, int enable, u32 delay);
int vuv__tcp_simultaneous_accepts(uv_tcp_t* handle, int enable);
int vuv__tcp_bind(uv_tcp_t* handle, const struct sockaddr* const_sockaddr, int flags);
int vuv__tcp_getsockname(const uv_tcp_t* const_handle, struct sockaddr* name, int* namelen);
int vuv__tcp_getpeername(const uv_tcp_t* const_handle, struct sockaddr* name, int* namelen);
int vuv__tcp_connect(uv_connect_t* req, uv_tcp_t* handle, const struct sockaddr* const_sockaddr, void (*cb)(uv_connect_t* req, int status));
int vuv__udp_init(uv_loop_t* loop, uv_udp_t* handle);
int vuv__udp_init_ex(uv_loop_t* loop, uv_udp_t* handle, vuv__Uv_udp_flags flags);
int vuv__udp_open(uv_udp_t* handle, int sock);
int vuv__udp_bind(uv_udp_t* handle, const struct sockaddr* const_sockaddr, int flags);
int vuv__udp_connect(uv_udp_t* handle, const struct sockaddr* const_sockaddr);
int vuv__udp_getpeername(const uv_udp_t* const_handle, struct sockaddr* name, int* namelen);
int vuv__udp_getsockname(uv_udp_t* handle, struct sockaddr* name, int* namelen);
int vuv__udp_set_membership(uv_udp_t* handle, char* multicast_addr, char* interface_addr, vuv__Uv_membership membership);
int vuv__udp_set_source_membership(uv_udp_t* handle, const char* const_multicast_addr, const char* const_interface_addr, const char* const_source_addr, vuv__Uv_membership membership);
int vuv__udp_set_multicast_loop(uv_udp_t* handle, int on);
int vuv__udp_set_multicast_ttl(uv_udp_t* handle, int ttl);
int vuv__udp_set_multicast_interface(uv_udp_t* handle, const char* const_interface_addr);
int vuv__udp_set_broadcast(uv_udp_t* handle, int on);
int vuv__udp_set_ttl(uv_udp_t* handle, int ttl);
int vuv__udp_send(uv_udp_send_t* req, uv_udp_t* handle, const uv_buf_t* const_bufs, u32 nbufs, struct sockaddr* addr, void (*cb)(uv_udp_send_t* req, int status));
int vuv__udp_try_send(uv_udp_t* handle, const uv_buf_t* const_bufs, u32 nbufs, const struct sockaddr* const_sockaddr);
int vuv__udp_recv_start(uv_udp_t* handle, void (*alloc_cb)(uv_handle_t* handle, usize suggested_size, uv_buf_t* buf), void (*recv_cb)(uv_udp_t* handle, isize nread, uv_buf_t* buf, struct sockaddr* addr, u32 flags));
int vuv__udp_using_recvmmsg(const uv_udp_t* const_handle);
int vuv__udp_recv_stop(uv_udp_t* handle);
usize vuv__udp_get_send_queue_size(const uv_udp_t* const_handle);
usize vuv__udp_get_send_queue_count(const uv_udp_t* const_handle);
int vuv__tty_init(uv_loop_t* loop, uv_tty_t* handle, int fd, int readable);
int vuv__tty_set_mode(uv_tty_t* handle, vuv__Uv_tty_mode mode);
int vuv__tty_reset_mode(void);
int vuv__tty_get_winsize(uv_tty_t* handle, int* width, int* height);
void vuv__tty_set_vterm_state(vuv__Uv_tty_vtermstate state);
vuv__Uv_handle_type vuv__guess_handle(int fd);
int vuv__pipe_init(uv_loop_t* loop, uv_pipe_t* handle, int ipc);
int vuv__pipe_open(uv_pipe_t* handle, int file);
...
int vuv__pipe_pending_count(uv_pipe_t* handle);
...
int vuv__prepare_start(uv_prepare_t* handle, void (*cb)(uv_prepare_t* handle));
int vuv__prepare_stop(uv_prepare_t* handle);
int vuv__check_init(uv_loop_t* loop, uv_check_t* handle);
int vuv__check_start(uv_check_t* handle, void (*cb)(uv_check_t* handle));
int vuv__check_stop(uv_check_t* handle);
int vuv__idle_init(uv_loop_t* loop, uv_idle_t* handle);
int vuv__idle_start(uv_idle_t* handle, void (*cb)(uv_idle_t* handle));
int vuv__idle_stop(uv_idle_t* handle);
int vuv__async_init(uv_loop_t* loop, uv_async_t* handle, void (*cb)(uv_async_t* handle));
int vuv__async_send(uv_async_t* handle);
int vuv__timer_init(uv_loop_t* loop, uv_timer_t* handle);
int vuv__timer_start(uv_timer_t* handle, void (*cb)(uv_timer_t* handle), u64 timeout, u64 repeat);
int vuv__timer_stop(uv_timer_t* handle);
int vuv__timer_again(uv_timer_t* handle);
void vuv__timer_set_repeat(uv_timer_t* handle, u64 repeat);
u64 vuv__timer_get_repeat(const uv_timer_t* const_handle);
u64 vuv__timer_get_due_in(const uv_timer_t* const_handle);
int vuv__getaddrinfo(uv_loop_t* loop, uv_getaddrinfo_t* req, void (*cb)(uv_getaddrinfo_t* req, int status, struct addrinfo* res), const char* const_node, const char* const_service, const struct addrinfo* const_hints);
void vuv__freeaddrinfo(struct addrinfo* ai);
int vuv__getnameinfo(uv_loop_t* loop, uv_getnameinfo_t* req, void (*cb)(uv_getnameinfo_t* req, int status, char* hostname, char* service), const struct sockaddr* const_sockaddr, int flags);
int vuv__uv_spawn(uv_loop_t* loop, uv_process_t* handle, uv_process_options_t* options);
int vuv__process_kill(uv_process_t* handle, int signum);
int vuv__kill(int pid, int signum);
void vuv__queue_work(uv_loop_t* loop, uv_work_t* work, void (*work_cb)(uv_work_t* work), void (*after_work_cb)(uv_work_t* work, int status));
int vuv__cancel(uv_req_t* req);
char** vuv__setup_args(int argc, char** argv);
int vuv__get_process_title(char* title, usize size);
int vuv__set_process_title(const char* const_title);
int vuv__resident_set_memory(usize* rss);
int vuv__uptime(f64* uptime);
int vuv__get_osfhandle(int fd);
int vuv__getrusage(uv_rusage_t* rusage);
int vuv__os_homedir(char* buf, usize* size);
int vuv__os_tmpdir(char* buf, usize* size);
int vuv__os_get_passwd(uv_passwd_t* pwd);
void vuv__os_free_passwd(uv_passwd_t* pwd);
int vuv__os_get_passwd2(uv_passwd_t* pwd, uv_uid_t uid);
int vuv__os_get_group(uv_group_t* group, uv_uid_t gid);
void vuv__os_free_group(uv_group_t* group);
int vuv__os_getpid(void);
int vuv__os_getppid(void);
int vuv__os_getpriority(int pid, int* priority);
int vuv__os_setpriority(int pid, int priority);
int vuv__thread_getpriority(uv_thread_t tid, int* priority);
int vuv__thread_setpriority(uv_thread_t tid, vuv__Uv_thread_priority priority);
usize vuv__available_parallelism(void);
int vuv__cpu_info(uv_cpu_info_t** cpu_infos, int* count);
void vuv__free_cpu_info(uv_cpu_info_t* cpu_infos, int count);
int vuv__cpumask_size(void);
int vuv__interface_addresses(uv_interface_address_t** addresses, int* count);
void vuv__free_interface_addresses(uv_interface_address_t* addresses, int count);
int vuv__os_environ(uv_env_item_t** env_items, int* count);
void vuv__os_free_environ(uv_env_item_t* env_items, int count);
int vuv__os_getenv(const char* const_name, char* buffer, usize* size);
int vuv__os_setenv(const char* const_name, const char* const_value);
int vuv__os_unsetenv(const char* const_name);
int vuv__os_gethostname(char* buffer, usize* size);
int vuv__os_uname(uv_utsname_t* buffer);
int vuv__metrics_info(uv_loop_t* loop, uv_metrics_t* metrics);
u64 vuv__metrics_idle_time(uv_loop_t* loop);
vuv__Uv_fs_type vuv__fs_get_type(const uv_fs_t* const_fs);
int vuv__fs_get_result(const uv_fs_t* const_fs);
int vuv__fs_get_system_error(const uv_fs_t* const_fs);
voidptr* vuv__fs_get_ptr(const uv_fs_t* const_fs);
string vuv__fs_get_path(const uv_fs_t* const_fs);
void vuv__fs_req_cleanup(uv_fs_t* fs);
void vuv__fs_close(uv_loop_t* loop, uv_fs_t* req, int file, void (*cb)(uv_fs_t* req));
void vuv__fs_open(uv_loop_t* loop, uv_fs_t* req, char* path, int flags, int mode, void (*cb)(uv_fs_t* req));
void vuv__fs_read(uv_loop_t* loop, uv_fs_t* req, int file, uv_buf_t* bufs, u32 nbufs, i64 offset, void (*cb)(uv_fs_t* req));
void vuv__fs_unlink(uv_loop_t* loop, uv_fs_t* req, char* path, void (*cb)(uv_fs_t* req));
void vuv__fs_write(uv_loop_t* loop, uv_fs_t* req, int file, uv_buf_t* bufs, u32 nbufs, i64 offset, void (*cb)(uv_fs_t* req));
int vuv__fs_copyfile(uv_loop_t* loop, uv_fs_t* req, const char* const_path, const char* const_new_path, int flags, void (*cb)(uv_fs_t* req));
void vuv__fs_mkdir(uv_loop_t* loop, uv_fs_t* req, char* path, int mode, void (*cb)(uv_fs_t* req));
int vuv__fs_mkdtemp(uv_loop_t* loop, uv_fs_t* req, const char* const_tpl, void (*cb)(uv_fs_t* req));
void vuv__fs_mkstemp(uv_loop_t* loop, uv_fs_t* req, const char* const_tpl, int flags, void (*cb)(uv_fs_t* req));
void vuv__fs_rmdir(uv_loop_t* loop, uv_fs_t* req, char* path, void (*cb)(uv_fs_t* req));
void vuv__fs_scandir(uv_loop_t* loop, uv_fs_t* req, char* path, int flags, void (*cb)(uv_fs_t* req));
int vuv__fs_scandir_next(uv_fs_t* req, uv_dirent_t* ent);
int vuv__fs_opendir(uv_loop_t* loop, uv_fs_t* req, const char* const_path, void (*cb)(uv_fs_t* req));
int vuv__fs_readdir(uv_loop_t* loop, uv_fs_t* req, uv_dir_t* dir, void (*cb)(uv_fs_t* req));
int vuv__fs_closedir(uv_loop_t* loop, uv_fs_t* req, uv_dir_t* dir, void (*cb)(uv_fs_t* req));
void vuv__fs_stat(uv_loop_t* loop, uv_fs_t* req, char* path, void (*cb)(uv_fs_t* req));
void vuv__fs_fstat(uv_loop_t* loop, uv_fs_t* req, int file, void (*cb)(uv_fs_t* req));
void vuv__fs_rename(uv_loop_t* loop, uv_fs_t* req, const char* const_path, const char* const_new_path, void (*cb)(uv_fs_t* req));
void vuv__fs_fsync(uv_loop_t* loop, uv_fs_t* req, int file, void (*cb)(uv_fs_t* req));
void vuv__fs_fdatasync(uv_loop_t* loop, uv_fs_t* req, int file, void (*cb)(uv_fs_t* req));
void vuv__fs_ftruncate(uv_loop_t* loop, uv_fs_t* req, int file, i64 offset, void (*cb)(uv_fs_t* req));
void vuv__fs_sendfile(uv_loop_t* loop, uv_fs_t* req, int out_fd, int in_fd, i64 in_offset, usize length, void (*cb)(uv_fs_t* req));
void vuv__fs_access(uv_loop_t* loop, uv_fs_t* req, const char* const_path, int mode, void (*cb)(uv_fs_t* req));
void vuv__fs_chmod(uv_loop_t* loop, uv_fs_t* req, const char* const_path, int mode, void (*cb)(uv_fs_t* req));
void vuv__fs_fchmod(uv_loop_t* loop, uv_fs_t* req, int file, int mode, void (*cb)(uv_fs_t* req));
void vuv__fs_utime(uv_loop_t* loop, uv_fs_t* req, const char* const_path, f64 atime, f64 mtime, void (*cb)(uv_fs_t* req));
int vuv__fs_utime_ex(uv_loop_t* loop, uv_fs_t* req, const char* const_path, f64 btime, f64 atime, f64 mtime, void (*cb)(uv_fs_t* req));
void vuv__fs_futime(uv_loop_t* loop, uv_fs_t* req, int file, f64 atime, f64 mtime, void (*cb)(uv_fs_t* req));
int vuv__fs_futime_ex(uv_loop_t* loop, uv_fs_t* req, int file, f64 btime, f64 atime, f64 mtime, void (*cb)(uv_fs_t* req));
int vuv__fs_lutime(uv_loop_t* loop, uv_fs_t* req, const char* const_path, f64 atime, f64 mtime, void (*cb)(uv_fs_t* req));
void vuv__fs_lstat(uv_loop_t* loop, uv_fs_t* req, char* path, void (*cb)(uv_fs_t* req));
void vuv__fs_link(uv_loop_t* loop, uv_fs_t* req, const char* const_path, const char* const_new_path, void (*cb)(uv_fs_t* req));
void vuv__fs_symlink(uv_loop_t* loop, uv_fs_t* req, const char* const_path, const char* const_new_path, int flags, void (*cb)(uv_fs_t* req));
void vuv__fs_readlink(uv_loop_t* loop, uv_fs_t* req, const char* const_path, void (*cb)(uv_fs_t* req));
void vuv__fs_realpath(uv_loop_t* loop, uv_fs_t* req, const char* const_path, void (*cb)(uv_fs_t* req));
void vuv__fs_chown(uv_loop_t* loop, uv_fs_t* req, const char* const_path, usize uid, usize gid, void (*cb)(uv_fs_t* req));
void vuv__fs_fchown(uv_loop_t* loop, uv_fs_t* req, int file, usize uid, usize gid, void (*cb)(uv_fs_t* req));
int vuv__fs_lchown(uv_loop_t* loop, uv_fs_t* req, const char* const_path, usize uid, usize gid, void (*cb)(uv_fs_t* req));
void vuv__fs_statfs(uv_loop_t* loop, uv_fs_t* req, const char* const_path, void (*cb)(uv_fs_t* req));
int vuv__fs_poll_init(uv_loop_t* loop, uv_fs_poll_t* handle);
int vuv__fs_poll_start(uv_fs_poll_t* handle, void (*cb)(uv_fs_poll_t* handle, int status, uv_stat_t* prev, uv_stat_t* curr), const char* const_path, usize interval);
int vuv__fs_poll_stop(uv_fs_poll_t* handle);
int vuv__fs_poll_getpath(uv_fs_poll_t* handle, char* path, usize* size);
int vuv__signal_init(uv_loop_t* loop, uv_signal_t* handle);
int vuv__signal_start(uv_signal_t* handle, void (*cb)(uv_signal_t* handle, int signum), int signum);
int vuv__signal_start_oneshot(uv_signal_t* signal, void (*cb)(uv_signal_t* handle, int signum), int signum);
int vuv__signal_stop(uv_signal_t* handle);
void vuv__loadavg(f64* avg);
int vuv__fs_event_init(uv_loop_t* loop, uv_fs_event_t* handle);
int vuv__fs_event_start(uv_fs_event_t* handle, void (*cb)(uv_fs_event_t* handle, const char* const_filename, int events, int status), const char* const_path, int flags);
int vuv__fs_event_stop(uv_fs_event_t* handle);
int vuv__fs_event_getpath(uv_fs_event_t* handle, char* path, usize* size);
int vuv__ip4_addr(const char* const_ip, int port, struct sockaddr_in* addr);
int vuv__ip4_name(const struct sockaddr_in* const_src, char* dst, usize size);
int vuv__ip_name(const struct sockaddr* const_src, char* dst, usize size);
int vuv__inet_ntop(int af, const voidptr* const_src, char* dst, usize size);
int vuv__inet_pton(int af, const char* const_src, voidptr* dst);
int vuv__random(uv_loop_t* loop, uv_random_t* req, voidptr buff, usize buflen, usize flalgs, void (*cb)(uv_random_t* req, int status, voidptr buf, usize buflen));
int vuv__if_indextoname(usize ifindex, char* buffer, usize* size);
int vuv__if_indextoiid(usize ifindex, char* buffer, usize* size);
int vuv__exepath(char* buffer, usize* size);
int vuv__cwd(char* buffer, usize* size);
int vuv__chdir(const char* const_dir);
u64 vuv__get_free_memory(void);
u64 vuv__get_total_memory(void);
u64 vuv__get_constrained_memory(void);
u64 vuv__get_available_memory(void);
int vuv__clock_gettime(vuv__Uv_clock_id clock_id, vuv__Uv_timespec* ts);
u64 vuv__hrtime(void);
void vuv__sleep(usize msec);
void vuv__disable_stdio_inheritance(void);
int vuv__mutex_init(uv_mutex_t* handle);
int vuv__mutex_init_recursive(uv_mutex_t* handle);
void vuv__mutex_destroy(uv_mutex_t* handle);
void vuv__mutex_lock(uv_mutex_t* handle);
int vuv__mutex_trylock(uv_mutex_t* handle);
void vuv__mutex_unlock(uv_mutex_t* handle);
int vuv__rwlock_init(uv_rwlock_t* handle);
void vuv__rwlock_destroy(uv_rwlock_t* handle);
void vuv__rwlock_rdlock(uv_rwlock_t* handle);
int vuv__rwlock_tryrdlock(uv_rwlock_t* handle);
void vuv__rwlock_rdunlock(uv_rwlock_t* handle);
void vuv__rwlock_wrlock(uv_rwlock_t* handle);
int vuv__rwlock_trywrlock(uv_rwlock_t* handle);
void vuv__rwlock_wrunlock(uv_rwlock_t* handle);
int vuv__sem_init(uv_sem_t* sem, usize value);
void vuv__sem_destroy(uv_sem_t* sem);
void vuv__sem_post(uv_sem_t* sem);
void vuv__sem_wait(uv_sem_t* sem);
int vuv__sem_trywait(uv_sem_t* sem);
int vuv__cond_init(uv_cond_t* handle);
void vuv__cond_destroy(uv_cond_t* handle);
void vuv__cond_signal(uv_cond_t* handle);
void vuv__cond_broadcast(uv_cond_t* handle);
void vuv__cond_wait(uv_cond_t* handle, uv_mutex_t* mutex);
void vuv__cond_timedwait(uv_cond_t* handle, uv_mutex_t* mutex, u64 timeout);
int vuv__barrier_init(uv_barrier_t* handle, usize count);
...
void vuv__key_set(uv_key_t* key, voidptr* value);
int vuv__thread_create(uv_thread_t* tid, void (*entry)(voidptr* arg), voidptr* arg);
int vuv__thread_setaffinity(uv_thread_t* tid, char* cpumask, char* oldmask, usize mask_size);
...
VV_LOCAL_SYMBOL u8* vuv__calloc_fn(usize count, usize size);
...
bool _const_vuv__compile_static; // inited later
string _const_vuv__libuv_path; // inited later
...
VNORETURN VV_LOCAL_SYMBOL void panic_debug(int line_no, string file, string mod, string fn_name, string s) {
	...
	#else
	{
		...
		eprintln( str_intp(2, _MOV((StrIntpData[]){{_SLIT("   v hash: "), 0xfe10, {.d_s = _SLIT("4ee948f")}}, {_SLIT0, 0, { .d_c = 0 }}})));
		eprintln(_SLIT("========================================="));
		#if defined(_VNATIVE)
		{
			exit(1);
...
string string_replace_each(string s, Array_string vals) {
	...
	if (idxs.len > 0) { qsort(idxs.data, idxs.len, idxs.element_size, (int (*)(const void *, const void *))&compare_12729529726086286208_RepIndex_by_idx); };
	u8* b = malloc_noscan((int)(new_len + 1));
	int idx_pos = 0;
...
string string_trim(string s, string cutset) {
	...
	if (string_len_utf8(cutset) == cutset.len) {
...
string vuv__version_string(void) {
	{ // Unsafe block
		string _t1 = cstring_to_vstring(uv_version_string());
		return _t1;
	}
	return (string){.str=(byteptr)"", .is_lit=1};
}
...
// TypeDecl
int vuv__replace_allocator(u8* (*malloc_fn)(isize size), u8* (*realloc_cb)(u8* ptr, isize size), u8* (*calloc_cb)(usize count, usize size), voidptr (*free_cb)(voidptr ptr)) {
	int _t1 = uv_replace_allocator((voidptr)malloc_fn, (voidptr)realloc_cb, (voidptr)calloc_cb, (voidptr)free_cb);
	return _t1;
}

uv_loop_t* vuv__default_loop(void) {
	uv_loop_t* _t1 = uv_default_loop();
	return _t1;
}

int vuv__loop_init(uv_loop_t* loop) {
	int _t1 = uv_loop_init(loop);
	return _t1;
}

int vuv__loop_close(uv_loop_t* loop) {
	int _t1 = uv_loop_close(loop);
	return _t1;
}

// Attr: [deprecated]
uv_loop_t* vuv__loop_new(void) {
	uv_loop_t* _t1 = uv_loop_new();
	return _t1;
}
...
usize vuv__loop_size(void) {
	usize _t1 = uv_loop_size();
	return _t1;
}

int vuv__loop_alive(const uv_loop_t* const_loop) {
	int _t1 = uv_loop_alive(const_loop);
	return _t1;
}

int vuv__loop_configure(uv_loop_t* loop, vuv__Uv_loop_option option, Array_voidptr args) {
	int _t1 = uv_loop_configure(loop, ((int)(option)), *(Array_voidptr*)array_get(args, 0));
	return _t1;
}

int vuv__loop_fork(uv_loop_t* loop) {
	int _t1 = uv_loop_fork(loop);
	return _t1;
}

int vuv__run(uv_loop_t* loop, vuv__Mode mode) {
	int _t1 = uv_run(loop, ((int)(mode)));
	return _t1;
}
...
int vuv__has_ref(const uv_handle_t* const_handle) {
	int _t1 = uv_has_ref(const_handle);
	return _t1;
}
...
u64 vuv__now(const uv_loop_t* const_loop) {
	u64 _t1 = uv_now(const_loop);
	return _t1;
}

int vuv__backend_fd(uv_loop_t* loop) {
	int _t1 = uv_backend_fd(loop);
	return _t1;
}

int vuv__backend_timeout(uv_loop_t* loop) {
	int _t1 = uv_backend_timeout(loop);
	return _t1;
}
...
// TypeDecl
int vuv__translate_sys_error(int sys_errno) {
	int _t1 = uv_translate_sys_error(sys_errno);
	return _t1;
}

string vuv__strerror(int err) {
	{ // Unsafe block
		string _t1 = cstring_to_vstring(uv_strerror(err));
		return _t1;
	}
	return (string){.str=(byteptr)"", .is_lit=1};
}
...
string vuv__err_name_r(int err, char* buff, u64 buflen) {
	{ // Unsafe block
		string _t1 = cstring_to_vstring(uv_err_name_r(err, buff, buflen));
		return _t1;
	}
	return (string){.str=(byteptr)"", .is_lit=1};
}
...
string vuv__err_name(int const_err) {
	{ // Unsafe block
		string _t1 = cstring_to_vstring(uv_err_name(const_err));
		return _t1;
	}
	return (string){.str=(byteptr)"", .is_lit=1};
}
...
int vuv__shutdown(uv_shutdown_t* req, uv_stream_t* handle, void (*cb)(uv_shutdown_t* req, int status)) {
	int _t1 = uv_shutdown(req, handle, (voidptr)cb);
	return _t1;
}

usize vuv__handle_size(vuv__Uv_handle_type handle_type) {
	usize _t1 = uv_handle_size(((int)(handle_type)));
	return _t1;
}

vuv__Uv_handle_type vuv__handle_get_type(const uv_handle_t* const_handle) {
	{ // Unsafe block
		vuv__Uv_handle_type _t1 = ((vuv__Uv_handle_type)(uv_handle_get_type(const_handle)));
		return _t1;
	}
	return 0;
}
...
string vuv__handle_type_name(vuv__Uv_handle_type const_handle_type) {
	{ // Unsafe block
		string _t1 = cstring_to_vstring(uv_handle_type_name(((int)(const_handle_type))));
		return _t1;
	}
	return (string){.str=(byteptr)"", .is_lit=1};
}
...
voidptr vuv__handle_get_data(const uv_handle_t* const_handle) {
	voidptr _t1 = uv_handle_get_data(const_handle);
	return _t1;
}

uv_loop_t* vuv__handle_get_loop(const uv_handle_t* const_handle) {
	uv_loop_t* _t1 = uv_handle_get_loop(const_handle);
	return _t1;
}
...
usize vuv__req_size(vuv__Uv_req_type req_type) {
	usize _t1 = uv_req_size(((int)(req_type)));
	return _t1;
}

voidptr vuv__req_get_data(const uv_req_t* const_req) {
	voidptr _t1 = uv_req_get_data(const_req);
	return _t1;
}
...
vuv__Uv_req_type vuv__req_get_type(const uv_req_t* const_req) {
	{ // Unsafe block
		vuv__Uv_req_type _t1 = ((vuv__Uv_req_type)(uv_req_get_type(const_req)));
		return _t1;
	}
	return 0;
}
...
string vuv__req_type_name(vuv__Uv_req_type const_req_type) {
	{ // Unsafe block
		string _t1 = cstring_to_vstring(uv_req_type_name(((int)(const_req_type))));
		return _t1;
	}
	return (string){.str=(byteptr)"", .is_lit=1};
}
...
int vuv__is_active(const uv_handle_t* const_handle) {
	int _t1 = uv_is_active(const_handle);
	return _t1;
}

void vuv__walk(uv_loop_t* loop, void (*walk_cb)(uv_handle_t* handle, voidptr arg), voidptr arg) {
	uv_walk(loop, (voidptr)walk_cb, arg);
}
...
void vuv__close(uv_handle_t* handle, void (*close_cb)(uv_handle_t* handle)) {
	uv_close(handle, (voidptr)close_cb);
}

int vuv__send_buffer_size(uv_handle_t* handle, int* value) {
	int _t1 = uv_send_buffer_size(handle, value);
	return _t1;
}

int vuv__recv_buffer_size(uv_handle_t* handle, int* value) {
	int _t1 = uv_recv_buffer_size(handle, value);
	return _t1;
}

int vuv__fileno(const uv_handle_t* const_handle, int* fd) {
	int _t1 = uv_fileno(const_handle, fd);
	return _t1;
}

uv_buf_t vuv__buf_init(u8* base, usize len) {
	uv_buf_t _t1 = uv_buf_init(((char*)(base)), len);
	return _t1;
}

usize vuv__stream_get_write_queue_size(const uv_stream_t* const_stream) {
	usize _t1 = uv_stream_get_write_queue_size(const_stream);
	return _t1;
}

int vuv__listen(uv_stream_t* stream, int backlog, void (*cb)(uv_stream_t* server, int status)) {
	int _t1 = uv_listen(stream, backlog, (voidptr)cb);
	return _t1;
}

int vuv__accept(uv_stream_t* server, uv_stream_t* client) {
	int _t1 = uv_accept(server, client);
	return _t1;
}

int vuv__read_start(uv_stream_t* stream, void (*alloc_cb)(uv_handle_t* handle, usize suggested_size, uv_buf_t* buf), void (*read_cb)(uv_stream_t* stream, isize nread, uv_buf_t* buf)) {
	int _t1 = uv_read_start(stream, (voidptr)alloc_cb, (voidptr)read_cb);
	return _t1;
}

int vuv__read_stop(uv_stream_t* stream) {
	int _t1 = uv_read_stop(stream);
	return _t1;
}

int vuv__write(uv_write_t* req, uv_stream_t* handle, const uv_buf_t* const_bufs, usize nbufs, void (*cb)(uv_write_t* req, int status)) {
	int _t1 = uv_write(req, handle, const_bufs, nbufs, (voidptr)cb);
	return _t1;
}

int vuv__write2(uv_write_t* req, uv_stream_t* handle, const uv_buf_t* const_bufs, usize nbufs, uv_stream_t* send_handle, void (*cb)(uv_write_t* req, int status)) {
	int _t1 = uv_write2(req, handle, const_bufs, nbufs, send_handle, (voidptr)cb);
	return _t1;
}

int vuv__try_write(uv_stream_t* handle, const uv_buf_t* const_bufs, usize nbufs) {
	int _t1 = uv_try_write(handle, const_bufs, nbufs);
	return _t1;
}

int vuv__try_write2(uv_stream_t* handle, const uv_buf_t* const_bufs, usize nbufs, uv_stream_t* send_handle) {
	int _t1 = uv_try_write2(handle, const_bufs, nbufs, send_handle);
	return _t1;
}

int vuv__is_readable(const uv_stream_t* const_handle) {
	int _t1 = uv_is_readable(const_handle);
	return _t1;
}

int vuv__is_writable(const uv_stream_t* const_handle) {
	int _t1 = uv_is_writable(const_handle);
	return _t1;
}

int vuv__stream_set_blocking(uv_stream_t* handle, int blocking) {
	int _t1 = uv_stream_set_blocking(handle, blocking);
	return _t1;
}

int vuv__is_closing(const uv_handle_t* const_handle) {
	int _t1 = uv_is_closing(const_handle);
	return _t1;
}

int vuv__tcp_init(uv_loop_t* loop, uv_tcp_t* handle) {
	int _t1 = uv_tcp_init(loop, handle);
	return _t1;
}

int vuv__tcp_init_ex(uv_loop_t* loop, uv_tcp_t* handle, usize flags) {
	int _t1 = uv_tcp_init_ex(loop, handle, flags);
	return _t1;
}

int vuv__tcp_open(uv_tcp_t* handle, int sock) {
	int _t1 = uv_tcp_open(handle, sock);
	return _t1;
}

int vuv__tcp_nodelay(uv_tcp_t* handle, int enable) {
	int _t1 = uv_tcp_nodelay(handle, enable);
	return _t1;
}

int vuv__tcp_keepalive(uv_tcp_t* handle, int enable, u32 delay) {
	int _t1 = uv_tcp_keepalive(handle, enable, delay);
	return _t1;
}

int vuv__tcp_simultaneous_accepts(uv_tcp_t* handle, int enable) {
	int _t1 = uv_tcp_simultaneous_accepts(handle, enable);
	return _t1;
}

int vuv__tcp_bind(uv_tcp_t* handle, const struct sockaddr* const_sockaddr, int flags) {
	int _t1 = uv_tcp_bind(handle, const_sockaddr, flags);
	return _t1;
}

int vuv__tcp_getsockname(const uv_tcp_t* const_handle, struct sockaddr* name, int* namelen) {
	int _t1 = uv_tcp_getsockname(const_handle, name, namelen);
	return _t1;
}

int vuv__tcp_getpeername(const uv_tcp_t* const_handle, struct sockaddr* name, int* namelen) {
	int _t1 = uv_tcp_getpeername(const_handle, name, namelen);
	return _t1;
}

int vuv__tcp_connect(uv_connect_t* req, uv_tcp_t* handle, const struct sockaddr* const_sockaddr, void (*cb)(uv_connect_t* req, int status)) {
	int _t1 = uv_tcp_connect(req, handle, const_sockaddr, (voidptr)cb);
	return _t1;
}
...
// TypeDecl
int vuv__udp_init(uv_loop_t* loop, uv_udp_t* handle) {
	int _t1 = uv_udp_init(loop, handle);
	return _t1;
}

int vuv__udp_init_ex(uv_loop_t* loop, uv_udp_t* handle, vuv__Uv_udp_flags flags) {
	int _t1 = uv_udp_init_ex(loop, handle, flags);
	return _t1;
}

int vuv__udp_open(uv_udp_t* handle, int sock) {
	int _t1 = uv_udp_open(handle, sock);
	return _t1;
}

int vuv__udp_bind(uv_udp_t* handle, const struct sockaddr* const_sockaddr, int flags) {
	int _t1 = uv_udp_bind(handle, const_sockaddr, flags);
	return _t1;
}

int vuv__udp_connect(uv_udp_t* handle, const struct sockaddr* const_sockaddr) {
	int _t1 = uv_udp_connect(handle, const_sockaddr);
	return _t1;
}

int vuv__udp_getpeername(const uv_udp_t* const_handle, struct sockaddr* name, int* namelen) {
	int _t1 = uv_udp_getpeername(const_handle, name, namelen);
	return _t1;
}

int vuv__udp_getsockname(uv_udp_t* handle, struct sockaddr* name, int* namelen) {
	int _t1 = uv_udp_getsockname(handle, name, namelen);
	return _t1;
}

int vuv__udp_set_membership(uv_udp_t* handle, char* multicast_addr, char* interface_addr, vuv__Uv_membership membership) {
	int _t1 = uv_udp_set_membership(handle, multicast_addr, interface_addr, ((int)(membership)));
	return _t1;
}

int vuv__udp_set_source_membership(uv_udp_t* handle, const char* const_multicast_addr, const char* const_interface_addr, const char* const_source_addr, vuv__Uv_membership membership) {
	int _t1 = uv_udp_set_source_membership(handle, const_multicast_addr, const_interface_addr, const_source_addr, ((int)(membership)));
	return _t1;
}

int vuv__udp_set_multicast_loop(uv_udp_t* handle, int on) {
	int _t1 = uv_udp_set_multicast_loop(handle, on);
	return _t1;
}

int vuv__udp_set_multicast_ttl(uv_udp_t* handle, int ttl) {
	int _t1 = uv_udp_set_multicast_ttl(handle, ttl);
	return _t1;
}

int vuv__udp_set_multicast_interface(uv_udp_t* handle, const char* const_interface_addr) {
	int _t1 = uv_udp_set_multicast_interface(handle, const_interface_addr);
	return _t1;
}

int vuv__udp_set_broadcast(uv_udp_t* handle, int on) {
	int _t1 = uv_udp_set_broadcast(handle, on);
	return _t1;
}

int vuv__udp_set_ttl(uv_udp_t* handle, int ttl) {
	int _t1 = uv_udp_set_ttl(handle, ttl);
	return _t1;
}

int vuv__udp_send(uv_udp_send_t* req, uv_udp_t* handle, const uv_buf_t* const_bufs, u32 nbufs, struct sockaddr* addr, void (*cb)(uv_udp_send_t* req, int status)) {
	int _t1 = uv_udp_send(req, handle, const_bufs, nbufs, addr, (voidptr)cb);
	return _t1;
}

int vuv__udp_try_send(uv_udp_t* handle, const uv_buf_t* const_bufs, u32 nbufs, const struct sockaddr* const_sockaddr) {
	int _t1 = uv_udp_try_send(handle, const_bufs, nbufs, const_sockaddr);
	return _t1;
}

int vuv__udp_recv_start(uv_udp_t* handle, void (*alloc_cb)(uv_handle_t* handle, usize suggested_size, uv_buf_t* buf), void (*recv_cb)(uv_udp_t* handle, isize nread, uv_buf_t* buf, struct sockaddr* addr, u32 flags)) {
	int _t1 = uv_udp_recv_start(handle, (voidptr)alloc_cb, (voidptr)recv_cb);
	return _t1;
}

int vuv__udp_using_recvmmsg(const uv_udp_t* const_handle) {
	int _t1 = uv_udp_using_recvmmsg(const_handle);
	return _t1;
}

int vuv__udp_recv_stop(uv_udp_t* handle) {
	int _t1 = uv_udp_recv_stop(handle);
	return _t1;
}

usize vuv__udp_get_send_queue_size(const uv_udp_t* const_handle) {
	usize _t1 = uv_udp_get_send_queue_size(const_handle);
	return _t1;
}

usize vuv__udp_get_send_queue_count(const uv_udp_t* const_handle) {
	usize _t1 = uv_udp_get_send_queue_count(const_handle);
	return _t1;
}

int vuv__tty_init(uv_loop_t* loop, uv_tty_t* handle, int fd, int readable) {
	int _t1 = uv_tty_init(loop, handle, fd, readable);
	return _t1;
}

int vuv__tty_set_mode(uv_tty_t* handle, vuv__Uv_tty_mode mode) {
	int _t1 = uv_tty_set_mode(handle, ((int)(mode)));
	return _t1;
}

int vuv__tty_reset_mode(void) {
	int _t1 = uv_tty_reset_mode();
	return _t1;
}

int vuv__tty_get_winsize(uv_tty_t* handle, int* width, int* height) {
	int _t1 = uv_tty_get_winsize(handle, width, height);
	return _t1;
}

void vuv__tty_set_vterm_state(vuv__Uv_tty_vtermstate state) {
	uv_tty_set_vterm_state(((int)(state)));
}

vuv__Uv_handle_type vuv__guess_handle(int fd) {
	{ // Unsafe block
		vuv__Uv_handle_type _t1 = ((vuv__Uv_handle_type)(uv_guess_handle(fd)));
		return _t1;
	}
	return 0;
}
...
int vuv__pipe_init(uv_loop_t* loop, uv_pipe_t* handle, int ipc) {
	int _t1 = uv_pipe_init(loop, handle, ipc);
	return _t1;
}

int vuv__pipe_open(uv_pipe_t* handle, int file) {
	int _t1 = uv_pipe_open(handle, file);
	return _t1;
}

int vuv__pipe_bind(uv_pipe_t* handle, const char* const_name) {
	int _t1 = uv_pipe_bind(handle, const_name);
	return _t1;
}

int vuv__pipe_bind2(uv_pipe_t* handle, const char* const_name, usize namelen, usize flags) {
	int _t1 = uv_pipe_bind2(handle, const_name, namelen, flags);
	return _t1;
}
...
int vuv__pipe_getpeername(uv_pipe_t* handle, char* name, usize* namelen) {
	int _t1 = uv_pipe_getpeername(handle, name, namelen);
	return _t1;
}
...
int vuv__pipe_pending_count(uv_pipe_t* handle) {
	int _t1 = uv_pipe_pending_count(handle);
	return _t1;
}

int vuv__pipe_pending_type(uv_pipe_t* handle) {
	int _t1 = uv_pipe_pending_type(handle);
	return _t1;
}

int vuv__pipe_chmod(uv_pipe_t* handle, int flags) {
	int _t1 = uv_pipe_chmod(handle, flags);
	return _t1;
}
...
int vuv__poll_init_socket(uv_loop_t* loop, uv_poll_t* handle, int socket) {
	...
	#else
	{
		_v_panic(_SLIT("uv_poll_init_socket is not available when building from source"));
		VUNREACHABLE();
		int _t2 = -1;
		return _t2;
	}
...
int vuv__poll_start(uv_poll_t* handle, int events, void (*cb)(uv_poll_t* handle, int status, int events)) {
	int _t1 = uv_poll_start(handle, events, (voidptr)cb);
	return _t1;
}

int vuv__poll_stop(uv_poll_t* handle) {
	int _t1 = uv_poll_stop(handle);
	return _t1;
}

int vuv__prepare_init(uv_loop_t* loop, uv_prepare_t* handle) {
	int _t1 = uv_prepare_init(loop, handle);
	return _t1;
}

int vuv__prepare_start(uv_prepare_t* handle, void (*cb)(uv_prepare_t* handle)) {
	int _t1 = uv_prepare_start(handle, (voidptr)cb);
	return _t1;
}

int vuv__prepare_stop(uv_prepare_t* handle) {
	int _t1 = uv_prepare_stop(handle);
	return _t1;
}

int vuv__check_init(uv_loop_t* loop, uv_check_t* handle) {
	int _t1 = uv_check_init(loop, handle);
	return _t1;
}

int vuv__check_start(uv_check_t* handle, void (*cb)(uv_check_t* handle)) {
	int _t1 = uv_check_start(handle, (voidptr)cb);
	return _t1;
}

int vuv__check_stop(uv_check_t* handle) {
	int _t1 = uv_check_stop(handle);
	return _t1;
}

int vuv__idle_init(uv_loop_t* loop, uv_idle_t* handle) {
	int _t1 = uv_idle_init(loop, handle);
	return _t1;
}

int vuv__idle_start(uv_idle_t* handle, void (*cb)(uv_idle_t* handle)) {
	int _t1 = uv_idle_start(handle, (voidptr)cb);
	return _t1;
}

int vuv__idle_stop(uv_idle_t* handle) {
	int _t1 = uv_idle_stop(handle);
	return _t1;
}

int vuv__async_init(uv_loop_t* loop, uv_async_t* handle, void (*cb)(uv_async_t* handle)) {
	int _t1 = uv_async_init(loop, handle, (voidptr)cb);
	return _t1;
}

int vuv__async_send(uv_async_t* handle) {
	int _t1 = uv_async_send(handle);
	return _t1;
}

int vuv__timer_init(uv_loop_t* loop, uv_timer_t* handle) {
	int _t1 = uv_timer_init(loop, handle);
	return _t1;
}

int vuv__timer_start(uv_timer_t* handle, void (*cb)(uv_timer_t* handle), u64 timeout, u64 repeat) {
	int _t1 = uv_timer_start(handle, (voidptr)cb, timeout, repeat);
	return _t1;
}

int vuv__timer_stop(uv_timer_t* handle) {
	int _t1 = uv_timer_stop(handle);
	return _t1;
}

int vuv__timer_again(uv_timer_t* handle) {
	int _t1 = uv_timer_again(handle);
	return _t1;
}
...
u64 vuv__timer_get_repeat(const uv_timer_t* const_handle) {
	u64 _t1 = uv_timer_get_repeat(const_handle);
	return _t1;
}

u64 vuv__timer_get_due_in(const uv_timer_t* const_handle) {
	u64 _t1 = uv_timer_get_due_in(const_handle);
	return _t1;
}

int vuv__getaddrinfo(uv_loop_t* loop, uv_getaddrinfo_t* req, void (*cb)(uv_getaddrinfo_t* req, int status, struct addrinfo* res), const char* const_node, const char* const_service, const struct addrinfo* const_hints) {
	int _t1 = uv_getaddrinfo(loop, req, (voidptr)cb, const_node, const_service, const_hints);
	return _t1;
}
...
int vuv__getnameinfo(uv_loop_t* loop, uv_getnameinfo_t* req, void (*cb)(uv_getnameinfo_t* req, int status, char* hostname, char* service), const struct sockaddr* const_sockaddr, int flags) {
	int _t1 = uv_getnameinfo(loop, req, (voidptr)cb, const_sockaddr, flags);
	return _t1;
}

int vuv__uv_spawn(uv_loop_t* loop, uv_process_t* handle, uv_process_options_t* options) {
	int _t1 = uv_spawn(loop, handle, options);
	return _t1;
}

int vuv__process_kill(uv_process_t* handle, int signum) {
	int _t1 = uv_process_kill(handle, signum);
	return _t1;
}

int vuv__kill(int pid, int signum) {
	int _t1 = uv_kill(pid, signum);
	return _t1;
}

void vuv__queue_work(uv_loop_t* loop, uv_work_t* work, void (*work_cb)(uv_work_t* work), void (*after_work_cb)(uv_work_t* work, int status)) {
	uv_queue_work(loop, work, (voidptr)work_cb, (voidptr)after_work_cb);
}

int vuv__cancel(uv_req_t* req) {
	int _t1 = uv_cancel(req);
	return _t1;
}

char** vuv__setup_args(int argc, char** argv) {
	char** _t1 = uv_setup_args(argc, argv);
	return _t1;
}

int vuv__get_process_title(char* title, usize size) {
	int _t1 = uv_get_process_title(title, size);
	return _t1;
}

int vuv__set_process_title(const char* const_title) {
	int _t1 = uv_set_process_title(const_title);
	return _t1;
}

int vuv__resident_set_memory(usize* rss) {
	int _t1 = uv_resident_set_memory(rss);
	return _t1;
}

int vuv__uptime(f64* uptime) {
	int _t1 = uv_uptime(uptime);
	return _t1;
}

int vuv__get_osfhandle(int fd) {
	int _t1 = uv_get_osfhandle(fd);
	return _t1;
}

int vuv__getrusage(uv_rusage_t* rusage) {
	int _t1 = uv_getrusage(rusage);
	return _t1;
}

int vuv__os_homedir(char* buf, usize* size) {
	int _t1 = uv_os_homedir(buf, size);
	return _t1;
}

int vuv__os_tmpdir(char* buf, usize* size) {
	int _t1 = uv_os_tmpdir(buf, size);
	return _t1;
}

int vuv__os_get_passwd(uv_passwd_t* pwd) {
	int _t1 = uv_os_get_passwd(pwd);
	return _t1;
}
...
int vuv__os_get_passwd2(uv_passwd_t* pwd, uv_uid_t uid) {
	int _t1 = uv_os_get_passwd2(pwd, uid);
	return _t1;
}

int vuv__os_get_group(uv_group_t* group, uv_uid_t gid) {
	int _t1 = uv_os_get_group(group, gid);
	return _t1;
}
...
int vuv__os_getpid(void) {
	int _t1 = uv_os_getpid();
	return _t1;
}

int vuv__os_getppid(void) {
	int _t1 = uv_os_getppid();
	return _t1;
}

int vuv__os_getpriority(int pid, int* priority) {
	int _t1 = uv_os_getpriority(pid, priority);
	return _t1;
}

int vuv__os_setpriority(int pid, int priority) {
	int _t1 = uv_os_setpriority(pid, priority);
	return _t1;
}

int vuv__thread_getpriority(uv_thread_t tid, int* priority) {
	int _t1 = uv_thread_getpriority(tid, priority);
	return _t1;
}

int vuv__thread_setpriority(uv_thread_t tid, vuv__Uv_thread_priority priority) {
	int _t1 = uv_thread_setpriority(tid, priority);
	return _t1;
}

usize vuv__available_parallelism(void) {
	usize _t1 = uv_available_parallelism();
	return _t1;
}

int vuv__cpu_info(uv_cpu_info_t** cpu_infos, int* count) {
	int _t1 = uv_cpu_info(cpu_infos, count);
	return _t1;
}
...
int vuv__cpumask_size(void) {
	int _t1 = uv_cpumask_size();
	return _t1;
}

int vuv__interface_addresses(uv_interface_address_t** addresses, int* count) {
	int _t1 = uv_interface_addresses(addresses, count);
	return _t1;
}
...
int vuv__os_environ(uv_env_item_t** env_items, int* count) {
	int _t1 = uv_os_environ(env_items, count);
	return _t1;
}
...
int vuv__os_getenv(const char* const_name, char* buffer, usize* size) {
	int _t1 = uv_os_getenv(const_name, buffer, size);
	return _t1;
}

int vuv__os_setenv(const char* const_name, const char* const_value) {
	int _t1 = uv_os_setenv(const_name, const_value);
	return _t1;
}

int vuv__os_unsetenv(const char* const_name) {
	int _t1 = uv_os_unsetenv(const_name);
	return _t1;
}

int vuv__os_gethostname(char* buffer, usize* size) {
	int _t1 = uv_os_gethostname(buffer, size);
	return _t1;
}

int vuv__os_uname(uv_utsname_t* buffer) {
	int _t1 = uv_os_uname(buffer);
	return _t1;
}

int vuv__metrics_info(uv_loop_t* loop, uv_metrics_t* metrics) {
	int _t1 = uv_metrics_info(loop, metrics);
	return _t1;
}

u64 vuv__metrics_idle_time(uv_loop_t* loop) {
	u64 _t1 = uv_metrics_idle_time(loop);
	return _t1;
}

vuv__Uv_fs_type vuv__fs_get_type(const uv_fs_t* const_fs) {
	{ // Unsafe block
		vuv__Uv_fs_type _t1 = ((vuv__Uv_fs_type)(uv_fs_get_type(const_fs)));
		return _t1;
	}
	return -1;
}
...
int vuv__fs_get_result(const uv_fs_t* const_fs) {
	int _t1 = uv_fs_get_result(const_fs);
	return _t1;
}

int vuv__fs_get_system_error(const uv_fs_t* const_fs) {
	int _t1 = uv_fs_get_system_error(const_fs);
	return _t1;
}

voidptr* vuv__fs_get_ptr(const uv_fs_t* const_fs) {
	voidptr* _t1 = uv_fs_get_ptr(const_fs);
	return _t1;
}

string vuv__fs_get_path(const uv_fs_t* const_fs) {
	{ // Unsafe block
		string _t1 = cstring_to_vstring(uv_fs_get_path(const_fs));
		return _t1;
	}
	return (string){.str=(byteptr)"", .is_lit=1};
}
...
void vuv__fs_close(uv_loop_t* loop, uv_fs_t* req, int file, void (*cb)(uv_fs_t* req)) {
	uv_fs_close(loop, req, file, (voidptr)cb);
}

void vuv__fs_open(uv_loop_t* loop, uv_fs_t* req, char* path, int flags, int mode, void (*cb)(uv_fs_t* req)) {
	uv_fs_open(loop, req, path, flags, mode, (voidptr)cb);
}

void vuv__fs_read(uv_loop_t* loop, uv_fs_t* req, int file, uv_buf_t* bufs, u32 nbufs, i64 offset, void (*cb)(uv_fs_t* req)) {
	uv_fs_read(loop, req, file, bufs, nbufs, offset, (voidptr)cb);
}

void vuv__fs_unlink(uv_loop_t* loop, uv_fs_t* req, char* path, void (*cb)(uv_fs_t* req)) {
	uv_fs_unlink(loop, req, path, (voidptr)cb);
}

void vuv__fs_write(uv_loop_t* loop, uv_fs_t* req, int file, uv_buf_t* bufs, u32 nbufs, i64 offset, void (*cb)(uv_fs_t* req)) {
	uv_fs_write(loop, req, file, bufs, nbufs, offset, (voidptr)cb);
}

int vuv__fs_copyfile(uv_loop_t* loop, uv_fs_t* req, const char* const_path, const char* const_new_path, int flags, void (*cb)(uv_fs_t* req)) {
	int _t1 = uv_fs_copyfile(loop, req, const_path, const_new_path, flags, (voidptr)cb);
	return _t1;
}

void vuv__fs_mkdir(uv_loop_t* loop, uv_fs_t* req, char* path, int mode, void (*cb)(uv_fs_t* req)) {
	uv_fs_mkdir(loop, req, path, mode, (voidptr)cb);
}

int vuv__fs_mkdtemp(uv_loop_t* loop, uv_fs_t* req, const char* const_tpl, void (*cb)(uv_fs_t* req)) {
	int _t1 = uv_fs_mkdtemp(loop, req, const_tpl, (voidptr)cb);
	return _t1;
}

void vuv__fs_mkstemp(uv_loop_t* loop, uv_fs_t* req, const char* const_tpl, int flags, void (*cb)(uv_fs_t* req)) {
	uv_fs_mkstemp(loop, req, const_tpl, (voidptr)cb);
}

void vuv__fs_rmdir(uv_loop_t* loop, uv_fs_t* req, char* path, void (*cb)(uv_fs_t* req)) {
	uv_fs_rmdir(loop, req, path, (voidptr)cb);
}

void vuv__fs_scandir(uv_loop_t* loop, uv_fs_t* req, char* path, int flags, void (*cb)(uv_fs_t* req)) {
	uv_fs_scandir(loop, req, path, flags, (voidptr)cb);
}

int vuv__fs_scandir_next(uv_fs_t* req, uv_dirent_t* ent) {
	int _t1 = uv_fs_scandir_next(req, ent);
	return _t1;
}

int vuv__fs_opendir(uv_loop_t* loop, uv_fs_t* req, const char* const_path, void (*cb)(uv_fs_t* req)) {
	int _t1 = uv_fs_opendir(loop, req, const_path, (voidptr)cb);
	return _t1;
}

int vuv__fs_readdir(uv_loop_t* loop, uv_fs_t* req, uv_dir_t* dir, void (*cb)(uv_fs_t* req)) {
	int _t1 = uv_fs_readdir(loop, req, dir, (voidptr)cb);
	return _t1;
}

int vuv__fs_closedir(uv_loop_t* loop, uv_fs_t* req, uv_dir_t* dir, void (*cb)(uv_fs_t* req)) {
	int _t1 = uv_fs_closedir(loop, req, dir, (voidptr)cb);
	return _t1;
}

void vuv__fs_stat(uv_loop_t* loop, uv_fs_t* req, char* path, void (*cb)(uv_fs_t* req)) {
	uv_fs_stat(loop, req, path, (voidptr)cb);
}

void vuv__fs_fstat(uv_loop_t* loop, uv_fs_t* req, int file, void (*cb)(uv_fs_t* req)) {
	uv_fs_fstat(loop, req, file, (voidptr)cb);
}

void vuv__fs_rename(uv_loop_t* loop, uv_fs_t* req, const char* const_path, const char* const_new_path, void (*cb)(uv_fs_t* req)) {
	uv_fs_rename(loop, req, const_path, const_new_path, (voidptr)cb);
}

void vuv__fs_fsync(uv_loop_t* loop, uv_fs_t* req, int file, void (*cb)(uv_fs_t* req)) {
	uv_fs_fsync(loop, req, file, (voidptr)cb);
}

void vuv__fs_fdatasync(uv_loop_t* loop, uv_fs_t* req, int file, void (*cb)(uv_fs_t* req)) {
	uv_fs_fdatasync(loop, req, file, (voidptr)cb);
}

void vuv__fs_ftruncate(uv_loop_t* loop, uv_fs_t* req, int file, i64 offset, void (*cb)(uv_fs_t* req)) {
	uv_fs_ftruncate(loop, req, file, offset, (voidptr)cb);
}

void vuv__fs_sendfile(uv_loop_t* loop, uv_fs_t* req, int out_fd, int in_fd, i64 in_offset, usize length, void (*cb)(uv_fs_t* req)) {
	uv_fs_sendfile(loop, req, out_fd, in_fd, in_offset, length, (voidptr)cb);
}

void vuv__fs_access(uv_loop_t* loop, uv_fs_t* req, const char* const_path, int mode, void (*cb)(uv_fs_t* req)) {
	uv_fs_access(loop, req, const_path, mode, (voidptr)cb);
}

void vuv__fs_chmod(uv_loop_t* loop, uv_fs_t* req, const char* const_path, int mode, void (*cb)(uv_fs_t* req)) {
	uv_fs_chmod(loop, req, const_path, mode, (voidptr)cb);
}

void vuv__fs_fchmod(uv_loop_t* loop, uv_fs_t* req, int file, int mode, void (*cb)(uv_fs_t* req)) {
	uv_fs_fchmod(loop, req, file, mode, (voidptr)cb);
}

void vuv__fs_utime(uv_loop_t* loop, uv_fs_t* req, const char* const_path, f64 atime, f64 mtime, void (*cb)(uv_fs_t* req)) {
	uv_fs_utime(loop, req, const_path, atime, mtime, (voidptr)cb);
}

int vuv__fs_utime_ex(uv_loop_t* loop, uv_fs_t* req, const char* const_path, f64 btime, f64 atime, f64 mtime, void (*cb)(uv_fs_t* req)) {
	#if !defined(true)
	{
		int _t2 = uv_fs_utime_ex(loop, req, const_path, btime, atime, mtime, (voidptr)cb);
		return _t2;
	}
	#else
	{
...
void vuv__fs_futime(uv_loop_t* loop, uv_fs_t* req, int file, f64 atime, f64 mtime, void (*cb)(uv_fs_t* req)) {
	uv_fs_futime(loop, req, file, atime, mtime, (voidptr)cb);
}

int vuv__fs_futime_ex(uv_loop_t* loop, uv_fs_t* req, int file, f64 btime, f64 atime, f64 mtime, void (*cb)(uv_fs_t* req)) {
	#if !defined(true)
	{
		int _t2 = uv_fs_futime_ex(loop, req, file, btime, atime, mtime, (voidptr)cb);
		return _t2;
	}
	#else
	{
...
int vuv__fs_lutime(uv_loop_t* loop, uv_fs_t* req, const char* const_path, f64 atime, f64 mtime, void (*cb)(uv_fs_t* req)) {
	int _t1 = uv_fs_lutime(loop, req, const_path, atime, mtime, (voidptr)cb);
	return _t1;
}

void vuv__fs_lstat(uv_loop_t* loop, uv_fs_t* req, char* path, void (*cb)(uv_fs_t* req)) {
	uv_fs_lstat(loop, req, path, (voidptr)cb);
}

void vuv__fs_link(uv_loop_t* loop, uv_fs_t* req, const char* const_path, const char* const_new_path, void (*cb)(uv_fs_t* req)) {
	uv_fs_link(loop, req, const_path, const_new_path, (voidptr)cb);
}

void vuv__fs_symlink(uv_loop_t* loop, uv_fs_t* req, const char* const_path, const char* const_new_path, int flags, void (*cb)(uv_fs_t* req)) {
	uv_fs_symlink(loop, req, const_path, const_new_path, flags, (voidptr)cb);
}

void vuv__fs_readlink(uv_loop_t* loop, uv_fs_t* req, const char* const_path, void (*cb)(uv_fs_t* req)) {
	uv_fs_readlink(loop, req, const_path, (voidptr)cb);
}

void vuv__fs_realpath(uv_loop_t* loop, uv_fs_t* req, const char* const_path, void (*cb)(uv_fs_t* req)) {
	uv_fs_realpath(loop, req, const_path, (voidptr)cb);
}

void vuv__fs_chown(uv_loop_t* loop, uv_fs_t* req, const char* const_path, usize uid, usize gid, void (*cb)(uv_fs_t* req)) {
	uv_fs_chown(loop, req, const_path, uid, gid, (voidptr)cb);
}

void vuv__fs_fchown(uv_loop_t* loop, uv_fs_t* req, int file, usize uid, usize gid, void (*cb)(uv_fs_t* req)) {
	uv_fs_fchown(loop, req, file, uid, gid, (voidptr)cb);
}

int vuv__fs_lchown(uv_loop_t* loop, uv_fs_t* req, const char* const_path, usize uid, usize gid, void (*cb)(uv_fs_t* req)) {
	int _t1 = uv_fs_lchown(loop, req, const_path, uid, gid, (voidptr)cb);
	return _t1;
}

void vuv__fs_statfs(uv_loop_t* loop, uv_fs_t* req, const char* const_path, void (*cb)(uv_fs_t* req)) {
	uv_fs_statfs(loop, req, const_path, (voidptr)cb);
}

int vuv__fs_poll_init(uv_loop_t* loop, uv_fs_poll_t* handle) {
	int _t1 = uv_fs_poll_init(loop, handle);
	return _t1;
}

int vuv__fs_poll_start(uv_fs_poll_t* handle, void (*cb)(uv_fs_poll_t* handle, int status, uv_stat_t* prev, uv_stat_t* curr), const char* const_path, usize interval) {
	int _t1 = uv_fs_poll_start(handle, (voidptr)cb, const_path, interval);
	return _t1;
}

int vuv__fs_poll_stop(uv_fs_poll_t* handle) {
	int _t1 = uv_fs_poll_stop(handle);
	return _t1;
}

int vuv__fs_poll_getpath(uv_fs_poll_t* handle, char* path, usize* size) {
	int _t1 = uv_fs_poll_getpath(handle, path, size);
	return _t1;
}

int vuv__signal_init(uv_loop_t* loop, uv_signal_t* handle) {
	int _t1 = uv_signal_init(loop, handle);
	return _t1;
}

int vuv__signal_start(uv_signal_t* handle, void (*cb)(uv_signal_t* handle, int signum), int signum) {
	int _t1 = uv_signal_start(handle, (voidptr)cb, signum);
	return _t1;
}

int vuv__signal_start_oneshot(uv_signal_t* signal, void (*cb)(uv_signal_t* handle, int signum), int signum) {
	int _t1 = uv_signal_start_oneshot(signal, (voidptr)cb, signum);
	return _t1;
}

int vuv__signal_stop(uv_signal_t* handle) {
	int _t1 = uv_signal_stop(handle);
	return _t1;
}
...
int vuv__fs_event_init(uv_loop_t* loop, uv_fs_event_t* handle) {
	int _t1 = uv_fs_event_init(loop, handle);
	return _t1;
}

int vuv__fs_event_start(uv_fs_event_t* handle, void (*cb)(uv_fs_event_t* handle, const char* const_filename, int events, int status), const char* const_path, int flags) {
	int _t1 = uv_fs_event_start(handle, (voidptr)cb, const_path, flags);
	return _t1;
}

int vuv__fs_event_stop(uv_fs_event_t* handle) {
	int _t1 = uv_fs_event_stop(handle);
	return _t1;
}

int vuv__fs_event_getpath(uv_fs_event_t* handle, char* path, usize* size) {
	int _t1 = uv_fs_event_getpath(handle, path, size);
	return _t1;
}

int vuv__ip4_addr(const char* const_ip, int port, struct sockaddr_in* addr) {
	int _t1 = uv_ip4_addr(const_ip, port, ((struct sockaddr_in*)(addr)));
	return _t1;
}

int vuv__ip4_name(const struct sockaddr_in* const_src, char* dst, usize size) {
	int _t1 = uv_ip4_name(const_src, dst, size);
	return _t1;
}

int vuv__ip_name(const struct sockaddr* const_src, char* dst, usize size) {
	int _t1 = uv_ip_name(const_src, dst, size);
	return _t1;
}

int vuv__inet_ntop(int af, const voidptr* const_src, char* dst, usize size) {
	int _t1 = uv_inet_ntop(af, const_src, dst, size);
	return _t1;
}

int vuv__inet_pton(int af, const char* const_src, voidptr* dst) {
	int _t1 = uv_inet_pton(af, const_src, dst);
	return _t1;
}

int vuv__random(uv_loop_t* loop, uv_random_t* req, voidptr buff, usize buflen, usize flalgs, void (*cb)(uv_random_t* req, int status, voidptr buf, usize buflen)) {
	int _t1 = uv_random(loop, req, buff, buflen, flalgs, (voidptr)cb);
	return _t1;
}

int vuv__if_indextoname(usize ifindex, char* buffer, usize* size) {
	int _t1 = uv_if_indextoname(ifindex, buffer, size);
	return _t1;
}

int vuv__if_indextoiid(usize ifindex, char* buffer, usize* size) {
	int _t1 = uv_if_indextoiid(ifindex, buffer, size);
	return _t1;
}

int vuv__exepath(char* buffer, usize* size) {
	int _t1 = uv_exepath(buffer, size);
	return _t1;
}

int vuv__cwd(char* buffer, usize* size) {
	int _t1 = uv_cwd(buffer, size);
	return _t1;
}

int vuv__chdir(const char* const_dir) {
	int _t1 = uv_chdir(const_dir);
	return _t1;
}

u64 vuv__get_free_memory(void) {
	u64 _t1 = uv_get_free_memory();
	return _t1;
}

u64 vuv__get_total_memory(void) {
	u64 _t1 = uv_get_total_memory();
	return _t1;
}

u64 vuv__get_constrained_memory(void) {
	u64 _t1 = uv_get_constrained_memory();
	return _t1;
}

u64 vuv__get_available_memory(void) {
	u64 _t1 = uv_get_available_memory();
	return _t1;
}
...
int vuv__clock_gettime(vuv__Uv_clock_id clock_id, vuv__Uv_timespec* ts) {
	...
	#else
	{
		int _t2 = uv_clock_gettime(((int)(clock_id)), ((uv_timespec_t*)(ts)));
		return _t2;
	}
	#endif
	return 0;
...
int vuv__mutex_init(uv_mutex_t* handle) {
	int _t1 = uv_mutex_init(handle);
	return _t1;
}

int vuv__mutex_init_recursive(uv_mutex_t* handle) {
	int _t1 = uv_mutex_init_recursive(handle);
	return _t1;
}
...
int vuv__mutex_trylock(uv_mutex_t* handle) {
	int _t1 = uv_mutex_trylock(handle);
	return _t1;
}
...
int vuv__rwlock_tryrdlock(uv_rwlock_t* handle) {
	int _t1 = uv_rwlock_tryrdlock(handle);
	return _t1;
}
...
int vuv__rwlock_trywrlock(uv_rwlock_t* handle) {
	int _t1 = uv_rwlock_trywrlock(handle);
	return _t1;
}
...
int vuv__sem_trywait(uv_sem_t* sem) {
	int _t1 = uv_sem_trywait(sem);
	return _t1;
}

int vuv__cond_init(uv_cond_t* handle) {
	int _t1 = uv_cond_init(handle);
	return _t1;
}
...
void vuv__cond_wait(uv_cond_t* handle, uv_mutex_t* mutex) {
	uv_cond_wait(handle, mutex);
}

void vuv__cond_timedwait(uv_cond_t* handle, uv_mutex_t* mutex, u64 timeout) {
	uv_cond_timedwait(handle, mutex, timeout);
}

int vuv__barrier_init(uv_barrier_t* handle, usize count) {
	int _t1 = uv_barrier_init(handle, count);
	return _t1;
}
...
void vuv__barrier_wait(uv_barrier_t* handle) {
	uv_barrier_wait(handle);
}

void vuv__once(uv_once_t* guard, void (*cb)(void)) {
...
int vuv__gettimeofday(vuv__Uv_timeval* tv) {
	...
	#else
	{
		int _t2 = uv_gettimeofday(((uv_timeval64_t*)(tv)));
		return _t2;
	}
	#endif
	return 0;
...
int vuv__thread_create(uv_thread_t* tid, void (*entry)(voidptr* arg), voidptr* arg) {
	int _t1 = uv_thread_create(tid, (voidptr)entry, arg);
	return _t1;
}

int vuv__thread_setaffinity(uv_thread_t* tid, char* cpumask, char* oldmask, usize mask_size) {
	int _t1 = uv_thread_setaffinity(tid, cpumask, oldmask, mask_size);
	return _t1;
}

int vuv__thread_getaffinity(uv_thread_t* tid, char* cpumask, usize mask_size) {
	int _t1 = uv_thread_getaffinity(tid, cpumask, mask_size);
	return _t1;
}

int vuv__thread_getcpu(void) {
	int _t1 = uv_thread_getcpu();
	return _t1;
}
...
int vuv__thread_equal(const uv_thread_t* const_t1, const uv_thread_t* const_t2) {
	int _t1 = uv_thread_equal(const_t1, const_t2);
	return _t1;
}

voidptr* vuv__loop_get_data(const uv_loop_t* const_loop) {
	voidptr* _t1 = uv_loop_get_data(const_loop);
	return _t1;
}
...
usize vuv__utf16_length_as_wtf8(const u16* const_utf16, usize utf16_len) {
	usize _t1 = uv_utf16_length_as_wtf8(const_utf16, utf16_len);
	return _t1;
}

int vuv__utf16_to_wtf8(const u16* const_utf16, usize utf16_len, char** wtf8_ptr, usize* wtf8_len_ptr) {
	int _t1 = uv_utf16_to_wtf8(const_utf16, utf16_len, wtf8_ptr, wtf8_len_ptr);
	return _t1;
}

VV_LOCAL_SYMBOL void vuv__init(void) {
	uv_replace_allocator((voidptr)_v_malloc, (voidptr)v_realloc, (voidptr)vuv__calloc_fn, (voidptr)_v_free);
	uv_setup_args(g_main_argc, g_main_argv);
}

// Attr: [inline]
inline VV_LOCAL_SYMBOL u8* vuv__calloc_fn(usize count, usize size) {
...
VV_LOCAL_SYMBOL _result_int main__HttpServer_bind(main__HttpServer hs, string ip, int port) {
	vuv__Sockaddr_in addr = ((vuv__Sockaddr_in){EMPTY_STRUCT_INITIALIZATION});
	vuv__ip4_addr(((char*)(ip.str)), port, &addr);
	vuv__Sockaddr* addy = ((vuv__Sockaddr*)(&addr));
	_result_int _t1;
	_result_ok(&(int[]) { vuv__tcp_bind(hs.server, addy, 0) }, (_result*)(&_t1), sizeof(int));
	return _t1;
}
...
VV_LOCAL_SYMBOL void main__main(void) {
	...
	if (_t1.is_error) {
		IError err = _t1.err;
		println(_SLIT("Bind error"));
		return;
	}
	
  (*(int*)_t1.data);
	_result_int _t2 = main__HttpServer_listen(server);
	if (_t2.is_error) {
		IError err = _t2.err;
		println(_SLIT("Listen error"));
		return;
	}
	
  (*(int*)_t2.data);
	println( str_intp(2, _MOV((StrIntpData[]){{_SLIT("http://localhost:"), 0xfe07, {.d_i32 = port}}, {_SLIT0, 0, { .d_c = 0 }}})));
	vuv__run(server.loop, vuv__Mode__default);
}
...
void _vinit(int ___argc, voidptr ___argv) {
	...
	// Initializations of consts for module vuv
{
	_const_vuv__compile_static = false;
}
{
	_const_vuv__libuv_path = _SLIT("");
}
	// Calling fn init() for module vuv
	vuv__init();
}
void _vcleanup(void) {
}
