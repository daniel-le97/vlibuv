...
// added by module `vuv`, file: flags.v:13:
...
usize* vuv__version(void);
char* vuv__version_string(void);
...
char* vuv__strerror(int err);
char* vuv__err_name_r(int err, char* buff, u64 buflen);
char* vuv__err_name(int const_err);
...
char* vuv__handle_type_name(vuv__Uv_handle_type const_handle_type);
...
char* vuv__req_type_name(vuv__Uv_req_type const_req_type);
...
int vuv__tty_get_vterm_state(vuv__Uv_tty_vtermstate* state);
...
int vuv__fs_event_start(uv_fs_event_t* handle, void (*cb)(uv_fs_event_t* handle, char* filename, int events, int status), char** path, int flags);
int vuv__fs_event_stop(uv_fs_event_t* handle);
int vuv__fs_event_getpath(uv_fs_event_t* handle, char* path, usize* size);
int vuv__ip4_addr(const char* const_ip, int port, struct sockaddr* addr);
...
int vuv__clock_gettime(vuv__Uv_clock_id clock_id, uv_timespec_t* ts);
...
#endif
usize* vuv__version(void) {
	usize* _t1 = uv_version();
	return _t1;
}

char* vuv__version_string(void) {
	char* _t1 = uv_version_string();
	return _t1;
}
...
int vuv__loop_configure(uv_loop_t* loop, vuv__Uv_loop_option option, Array_voidptr args) {
	int _t1 = uv_loop_configure(loop, option, *(Array_voidptr*)array_get(args, 0));
	return _t1;
}
...
char* vuv__strerror(int err) {
	char* _t1 = uv_strerror(err);
	return _t1;
}

char* vuv__err_name_r(int err, char* buff, u64 buflen) {
	char* _t1 = uv_err_name_r(err, buff, buflen);
	return _t1;
}

char* vuv__err_name(int const_err) {
	char* _t1 = uv_err_name(const_err);
	return _t1;
}
...
usize vuv__handle_size(vuv__Uv_handle_type handle_type) {
	usize _t1 = uv_handle_size(handle_type);
	return _t1;
}

vuv__Uv_handle_type vuv__handle_get_type(const uv_handle_t* const_handle) {
	vuv__Uv_handle_type _t1 = uv_handle_get_type(const_handle);
	return _t1;
}

char* vuv__handle_type_name(vuv__Uv_handle_type const_handle_type) {
	char* _t1 = uv_handle_type_name(const_handle_type);
	return _t1;
}
...
usize vuv__req_size(vuv__Uv_req_type req_type) {
	usize _t1 = uv_req_size(req_type);
	return _t1;
}
...
vuv__Uv_req_type vuv__req_get_type(const uv_req_t* const_req) {
	vuv__Uv_req_type _t1 = uv_req_get_type(const_req);
	return _t1;
}

char* vuv__req_type_name(vuv__Uv_req_type const_req_type) {
	char* _t1 = uv_req_type_name(const_req_type);
	return _t1;
}
...
int vuv__udp_set_membership(uv_udp_t* handle, char* multicast_addr, char* interface_addr, vuv__Uv_membership membership) {
	int _t1 = uv_udp_set_membership(handle, multicast_addr, interface_addr, membership);
	return _t1;
}

int vuv__udp_set_source_membership(uv_udp_t* handle, const char* const_multicast_addr, const char* const_interface_addr, const char* const_source_addr, vuv__Uv_membership membership) {
	int _t1 = uv_udp_set_source_membership(handle, const_multicast_addr, const_interface_addr, const_source_addr, membership);
	return _t1;
}
...
int vuv__tty_set_mode(uv_tty_t* handle, vuv__Uv_tty_mode mode) {
	int _t1 = uv_tty_set_mode(handle, mode);
	return _t1;
}
...
int vuv__tty_get_vterm_state(vuv__Uv_tty_vtermstate* state) {
	int _t1 = uv_tty_get_vterm_state(state);
	return _t1;
}

vuv__Uv_handle_type vuv__guess_handle(int fd) {
	vuv__Uv_handle_type _t1 = uv_guess_handle(fd);
	return _t1;
}
...
vuv__Uv_fs_type vuv__fs_get_type(const uv_fs_t* const_fs) {
	vuv__Uv_fs_type _t1 = uv_fs_get_type(const_fs);
	return _t1;
}

usize* vuv__fs_get_result(const uv_fs_t* const_fs) {
	usize* _t1 = uv_fs_get_result(const_fs);
	return _t1;
}
...
char* vuv__fs_get_path(const uv_fs_t* const_fs) {
	char* _t1 = uv_fs_get_path(const_fs);
	return _t1;
}
...
int vuv__fs_event_start(uv_fs_event_t* handle, void (*cb)(uv_fs_event_t* handle, char* filename, int events, int status), char** path, int flags) {
	int _t1 = uv_fs_event_start(handle, (voidptr)cb, path, flags);
	return _t1;
}
...
int vuv__ip4_addr(const char* const_ip, int port, struct sockaddr* addr) {
	int _t1 = uv_ip4_addr(const_ip, port, addr);
	return _t1;
}
...
int vuv__clock_gettime(vuv__Uv_clock_id clock_id, uv_timespec_t* ts) {
	int _t1 = uv_clock_gettime(clock_id, ts);
	return _t1;
}
...
VV_LOCAL_SYMBOL _result_int main__HttpServer_bind(main__HttpServer hs, string ip, int port) {
	...
	_result_int _t1;
	_result_ok(&(int[]) { vuv__tcp_bind(hs.server, &addr, 0) }, (_result*)(&_t1), sizeof(int));
	return _t1;
}
...
{
	_const_vuv__compile_static = true;
}
{
